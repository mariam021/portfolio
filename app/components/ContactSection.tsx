			...
			<div className="max-w-4xl mx-auto">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center space-y-8">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<a
							href="mailto:mm5253@fayoum.edu.eg"
					...
					<div className="flex justify-center gap-6">
						<a
							href="https://github.com/mariam021"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/mariam-mohamed-552004278?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-600 hover:text-gray-900 transition-colors p-2 hover:bg-gray-100 rounded-full"
						>
